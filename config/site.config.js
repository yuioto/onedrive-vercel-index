...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'lin@yuioto.onmicrosoft.com',
  ...
  email: 'mailto:yuiotochan@outlook.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/yuioto/onedrive-vercel-index',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/yuiotochan',
    },
  ],
